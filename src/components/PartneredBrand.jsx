    ...
    <div className="bg-[#FCFAFA] py-12 md:py-24 px-4 md:px-24">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center justify-center md:justify-start flex-wrap gap-6 md:gap-18">
          ...
          <img src="/brands/treehouse.svg" alt="Treehouse" className="h-7 md:h-20 object-contain" />
          <img src="/brands/upwork.svg" alt="Upwork" className="h-7 md:h-20 object-contain" />
        </div>
      </div>
    </div>
  );
